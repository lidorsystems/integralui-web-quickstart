...
@Component({
    selector: '',
    templateUrl: './tabstrip-animation-types.html',
    styleUrls: ['./tabstrip-animation-types.css']
})
export class TabStripAnimationTypes {
    ...
    onAnimationTypeChecked(e: any){
        switch (e.detail.index){
            case 1:
                this.currentAnimation = IntegralUIAnimationType.Fade;
                break;

            case 2:
                this.currentAnimation = IntegralUIAnimationType.Slide;
                break;

            default:
                this.currentAnimation = IntegralUIAnimationType.None;
                break;
        }
    }
}
