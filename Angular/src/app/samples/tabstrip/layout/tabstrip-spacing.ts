...
@Component({
    selector: '',
    templateUrl: './tabstrip-spacing.html',
    styleUrls: ['./tabstrip-spacing.css']
})
export class TabStripSpacing {
    ...
    public spacingValue: number = 2;
    public tabs: Array<any> = [];
    public ctrlSpacingSize: any = { width: 100 };
    ...
    onSpacingChanged(e: any){
        this.spacingValue = e.detail.value;
    }
}
