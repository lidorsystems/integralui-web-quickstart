...
import { IntegralUIAnimationType, IntegralUIOrientation, IntegralUITabStripPlacement, IntegralUITheme } from 'integralui-web/components/integralui.enums';

@Component({
    selector: '',
    templateUrl: './tabstrip-orientation.html',
    styleUrls: ['./tabstrip-orientation.css']
})
export class TabStripTabOrientation {

    public currentAnimation: IntegralUIAnimationType = IntegralUIAnimationType.Slide;
    public currentOrientation: IntegralUIOrientation = IntegralUIOrientation.Horizontal;
    ...
    onOrientationChecked(e: any){
        this.currentOrientation = e.detail.index === 1 ? IntegralUIOrientation.Vertical : IntegralUIOrientation.Horizontal;
    }
