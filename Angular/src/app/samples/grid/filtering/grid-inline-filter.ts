...
@Component({
    selector: '',
    templateUrl: './grid-inline-filter.html',
    styleUrls: ['./grid-inline-filter.css']
})
export class GridInlineFilter {
    ...
    private loadFromJSON(){
        ...
        self.http.get("./assets/grid-inline-filter-data.json").subscribe((data: any) => {
