...
@Component({
    selector: '',
    templateUrl: './grid-form-editing.html',
    styleUrls: ['./grid-form-editing.css']
})
export class GridFormEditing {
    ...
    private loadFromJSON(){
        ...
        self.http.get("./assets/grid-form-editing-data.json").subscribe((data: any) => {
