...
import { IntegralUIDateFormat, IntegralUIEditMode, IntegralUIEditorType, IntegralUITheme, IntegralUIWeekDays } from 'integralui-web/components/integralui.enums';
import { iuiGridEditorsDatePickerStyle } from './grid-editors-datepicker.style';

@Component({
    selector: '',
    templateUrl: './grid-editors-datepicker.html',
    styleUrls: ['./grid-editors-datepicker.css']
})
export class GridEditorsDatePicker {
    ...
    public customStyle: any = iuiGridEditorsDatePickerStyle;
