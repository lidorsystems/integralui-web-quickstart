...
import { iuiGridEditorsDropDownListStyle } from './grid-editors-dropdownlist.style';

@Component({
    selector: '',
    templateUrl: './grid-editors-dropdownlist.html',
    styleUrls: ['./grid-editors-dropdownlist.css']
})
export class GridEditorsDropDownList {
    ...
    public customStyle: any = iuiGridEditorsDropDownListStyle;
