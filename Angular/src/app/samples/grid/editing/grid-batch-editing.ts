...
import { iuiGridBatchEditingStyle } from './grid-batch-editing.style';

@Component({
    selector: '',
    templateUrl: './grid-batch-editing.html',
    styleUrls: ['./grid-batch-editing.css']
})
export class GridBatchEditing {
    ...
    private loadFromJSON(){
        ...
        self.http.get("./assets/grid-batch-editing-data.json").subscribe((data: any) => {
    ...
    saveChanges(keep?: boolean){
        ...
        this.grid.nativeElement.endEdit(keep);
    }
