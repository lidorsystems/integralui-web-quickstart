...
import { IntegralUISortMode, IntegralUISortOrder, IntegralUITheme } from 'integralui-web/components/integralui.enums';

@Component({
    selector: '',
    templateUrl: './grid-multi-column-sorting.html',
    styleUrls: ['./grid-multi-column-sorting.css']
})
export class GridMultiColumnSorting {
    ...
    public currentSortMode: IntegralUISortMode = IntegralUISortMode.Multiple;
    ...
    onColumnSortClick(e: any){
        ...
        if (currentColumn && currentColumn.id === 4){
            ...
            this.grid.nativeElement.sort(currentColumn, e.detail.sorting);
        }
    }
}
