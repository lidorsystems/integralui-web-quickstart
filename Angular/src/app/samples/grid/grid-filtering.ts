...
import { iuiGridFilteringStyle } from './grid-filtering.style.js';

@Component({
    selector: '',
    templateUrl: './grid-filtering.html',
    styleUrls: ['./grid-filtering.css']
})
export class GridFiltering {
    ...
    public customStyle: any = iuiGridFilteringStyle;
                ...
                return html`
                    <div>
                        <iui-dropdownbutton data-column-dropdown
                            ...
                            .customStyle=${iuiGridFilteringStyle}
                            .data="${column}"
