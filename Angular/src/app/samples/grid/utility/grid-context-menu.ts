...
import { iuiGridContextMenuStyle } from './grid-context-menu.style';

@Component({
    selector: '',
    templateUrl: './grid-context-menu.html',
    styleUrls: ['./grid-context-menu.css']
})
export class GridContextMenu {
    ...
    columnMenuClick(e: any){
        if (e.detail.item){
            ...
            switch (e.detail.item.id){
                case 3:
                    this.grid.nativeElement.addColumn(this.createNewColumn());
                    break;

                case 4:
                    this.grid.nativeElement.insertColumnBefore(this.createNewColumn(), this.selColumn);
                    break;

                case 5:
                    this.grid.nativeElement.insertColumnAfter(this.createNewColumn(), this.selColumn);
                    break;

                case 7:
                    this.grid.nativeElement.removeColumn(this.selColumn);
                    break;
    ...
    rowMenuClick(e: any){
        if (e.detail.item){
            ...
            switch (e.detail.item.id){
                case 3:
                    this.grid.nativeElement.addRow(this.createNewRow());
                    break;

                case 4:
                    this.grid.nativeElement.insertRowBefore(this.createNewRow(), this.selRow);
                    break;

                case 5:
                    this.grid.nativeElement.insertRowAfter(this.createNewRow(), this.selRow);
                    break;

                case 7:
                    this.grid.nativeElement.removeRow(this.selRow);
                    break;
