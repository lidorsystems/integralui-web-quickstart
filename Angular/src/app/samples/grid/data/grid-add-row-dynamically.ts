...
import { iuiGridAddRowDynamicallyStyle } from './grid-add-row-dynamically.style';
...
export class GridAddRowDynamically {
    ...
    addRow(){
        ...
        this.grid.nativeElement.beginEdit(this.currentEditRow);

        this.setFocusToCell();
    }

    async cancelEdit(row: any){
        this.grid.nativeElement.endEdit();
    ...
    async saveRow(row: any, focusCell?: any){
        ...
        this.grid.nativeElement.endEdit(true);
        this.resetEditor();
        this.isNewRow = false;
    }
