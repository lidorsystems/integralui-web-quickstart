...
import { iuiGridCellTemplatesStyle } from './grid-cell-templates.style';

@Component({
    selector: '',
    templateUrl: './grid-cell-templates.html',
    styleUrls: ['./grid-cell-templates.css']
})
export class GridCellTemplates {
    ...
    public customStyle: any = iuiGridCellTemplatesStyle;
