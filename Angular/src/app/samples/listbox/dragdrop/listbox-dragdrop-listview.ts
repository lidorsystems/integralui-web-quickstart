...
@Component({
    selector: '',
    templateUrl: './listbox-dragdrop-listview.html',
    styleUrls: ['./listbox-dragdrop-listview.css']
})
export class ListBoxDDListView {
    // General settings
    ...
    public itemSize: any = { width: 150, height: 32 }
