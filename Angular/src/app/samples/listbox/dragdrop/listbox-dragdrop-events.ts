...
import { iuiListBoxDDEventStyle } from './listbox-dragdrop-events.style';

@Component({
    selector: '',
    templateUrl: './listbox-dragdrop-events.html',
    styleUrls: ['./listbox-dragdrop-events.css']
})
export class ListBoxDDEVents {
    // General settings
    ...
    public listStyle: any = iuiListBoxDDEventStyle;
