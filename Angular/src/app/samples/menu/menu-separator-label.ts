...
import { iuiMenuSeparatorLabelStyle } from './menu-separator-label.style';

@Component({
    selector: '',
    templateUrl: './menu-separator-label.html',
    styleUrls: ['./menu-separator-label.css']
})
export class MenuSeparatorLabel {
    public ctrlSize: any = { width: 700 };
    public currentResourcePath: string = 'assets/icons';
    public customStyle: any = iuiMenuSeparatorLabelStyle;
