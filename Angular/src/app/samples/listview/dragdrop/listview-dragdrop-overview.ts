...
import { iuiListViewDragDropOverviewStyle } from './listview-dragdrop-overview.style';

@Component({
    selector: '',
    templateUrl: './listview-dragdrop-overview.html',
    styleUrls: ['./listview-dragdrop-overview.css']
})
export class ListViewDDOverview {
