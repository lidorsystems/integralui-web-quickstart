...
export const iuiTreeGridCustomHeaderFooterStyle = css`
    ...
    .iui-checkbox {
        ...
        --iui-checkbox-btn-checked-background-image: url(assets/icons/checkbox-checked.ico);
        --iui-checkbox-btn-indeterminate-background-image: url(assets/icons/checkbox-indeterminate.ico);
        --iui-checkbox-btn-unchecked-background-image: url(assets/icons/checkbox-unchecked.ico);
