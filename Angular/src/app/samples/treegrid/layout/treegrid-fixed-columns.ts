...
import { IntegralUIEditorType, IntegralUITheme, IntegralUIVisibility } from 'integralui-web/components/integralui.enums';
import { iuiTreeGridFixedColumnsStyle } from './treegrid-fixed-columns.style';
...
export class TreeGridFixedColumns {
    ...
    private loadFromJSON(){
        ...
        self.http.get("./assets/treegrid-fixed-columns-data.json").subscribe((data: any) => {
