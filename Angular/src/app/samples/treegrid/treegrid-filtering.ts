...
@Component({
    selector: '',
    templateUrl: './treegrid-filtering.html',
    styleUrls: ['./treegrid-filtering.css']
})
export class TreeGridFiltering {
    ...
    public customStyle: any = iuiTreeGridFilteringStyle;
    ...
    ngAfterViewInit(){
        this.treegrid.nativeElement.loadData(this.flatData);
        ...
        return html`
            <div class="treegrid-ftr-panel">
                ...
                <div class="treegrid-ftr-inline-block" style="margin-top:10px">
                    <iui-select .allowAnimation="${true}" .items=${this.filterAuthors} .selectedItem=${this.selAuthor[0]} .size=${this.selectSize} @selectionChanged="${(e) => this.filterAuthorChanged(e, 0)}"></iui-select>
                ...
                <div class="treegrid-ftr-inline-block">
                    <iui-radiogroup .resourcePath=${this.currentResourcePath} .theme=${this.currentTheme} @buttonChecked=${(e) => this.authorCombinatorChanged(e)}>
                        <iui-radiobutton .checked=${true}>And</iui-radiobutton>
                        <iui-radiobutton>Or</iui-radiobutton>
                    </iui-radiogroup>
                </div><br/>
                <div class="treegrid-ftr-inline-block">
                    <iui-select .allowAnimation="${true}" .items=${this.filterAuthors} .selectedItem=${this.selAuthor[1]} .size=${this.selectSize} @selectionChanged="${(e) => this.filterAuthorChanged(e, 1)}"></iui-select>
    ...
    currentPriceDropDownTemplate = (column) => { 
        return html`
            <div class="treegrid-ftr-panel">
                <label>Show rows where: </label><br/>
                <div class="treegrid-ftr-inline-block" style="margin-top:10px">
                    <iui-select .allowAnimation="${true}" .items=${this.filterPrices} .selectedItem=${this.selPrice[0]} .size=${this.selectSize} @selectionChanged="${(e) => this.filterPriceChanged(e, 0)}"></iui-select>
                    <iui-numeric .min=${0} .max=${1000} .resourcePath=${this.currentResourcePath} .size=${this.inputSize} .value=${this.priceValues[0]} .theme=${this.currentTheme} @valueChanged=${(e) => this.priceValueChanged(e, 0)}></iui-numeric>
                </div>
                <div class="treegrid-ftr-inline-block">
                    <iui-radiogroup .resourcePath=${this.currentResourcePath} .theme=${this.currentTheme} @buttonChecked=${(e) => this.priceCombinatorChanged(e)}>
                        <iui-radiobutton .checked=${true}>And</iui-radiobutton>
                        <iui-radiobutton>Or</iui-radiobutton>
                    </iui-radiogroup>
                </div><br/>
                <div class="treegrid-ftr-inline-block">
                    <iui-select .allowAnimation="${true}" .items=${this.filterPrices} .selectedItem=${this.selPrice[1]} .size=${this.selectSize} @selectionChanged="${(e) => this.filterPriceChanged(e, 1)}"></iui-select>
                    <iui-numeric .min=${0} .max=${1000} .resourcePath=${this.currentResourcePath} .size=${this.inputSize} .value=${this.priceValues[1]} .theme=${this.currentTheme} @valueChanged=${(e) => this.priceValueChanged(e, 1)}></iui-numeric>
                </div>
                <div class="treegrid-ftr-inline-block" style="display:block;margin-top:15px;text-align:center;">
    ...
    applyAuthors(){
        ...
        if (filterConditions.length > 0){
            ...
            this.treegrid.nativeElement.filter(this.columns[1], params);
        }
        else
            this.treegrid.nativeElement.filter(this.columns[1]);
    ...
    applyPrices(){
        ...
        if (filterConditions.length > 0){
            ...
            this.treegrid.nativeElement.filter(this.columns[2], params);
        }
        else
            this.treegrid.nativeElement.filter(this.columns[2]);
