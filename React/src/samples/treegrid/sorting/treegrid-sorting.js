...
class TreeGridSorting extends Component {
    ...
    render() {
        return (
            <div>
                ...
                <div className="sample-block" id="treegrid-sorting">
                    ...
                    <div className="feature-help">
                        <p><span className="initial-space"></span>This sample demonstrates basic and custom sorting operations in the TreeGrid component.</p>
                        ...
                        <p><span className="initial-space"></span>For columns which cells contains custom values, a <span className="code-name">comparer</span> function is required. In case of this example, 3rd column contains date values, and a custom comparer function is created and applied to the TreeGrid.</p>
                        ...
                        <ul className="feature-points">
                            ...
                            <li><span className="code-name">sort</span> a method which sorts the TreeGrid rows based on applied order for specified column</li>
                        </ul>
...
export default TreeGridSorting;
