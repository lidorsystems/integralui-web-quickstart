...
class TreeGridBuiltInEditors extends Component {
    ...
    render() {
        return (
            <div>
                <h2>TreeGrid / Built-in Editors</h2>
                <div className="sample-block" id="treegrid-builtin-editors">
...
export default TreeGridBuiltInEditors;
