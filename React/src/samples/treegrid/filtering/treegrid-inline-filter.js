...
import gridData from './treegrid-inline-filter-data.json';

class TreeGridInlineFilter extends Component {
    ...
    render() {
        return (
            <div>
                <h2>TreeGrid / Inline Filter</h2>
                <div className="sample-block" id="treegrid-inline-filter">
...
export default TreeGridInlineFilter;
