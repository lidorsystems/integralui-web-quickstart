...
class TreeGridCellTemplates extends Component {
    ...
    render() {
        return (
            <div>
                ...
                <div className="sample-block" id="treegrid-cell-templates">
                    <IntegralUITreeGridComponent ref={this.gridRef}
                        allowAnimation={this.state.isAnimationAllowed} 
                        columns={this.state.columns} 
                        customStyle={iuiTreeGridCellTemplatesStyle}
                    ...
                    <div className="feature-help">
                        <p><span className="initial-space"></span>An example of a TreeGrid where some of the cells are using custom template for their content:</p>
...
export default TreeGridCellTemplates;
