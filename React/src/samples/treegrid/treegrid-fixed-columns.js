...
import gridData from './treegrid-fixed-columns-data.json';
...
class TreeGridFixedColumns extends Component {
    ...
    render() {
        return (
            <div>
                ...
                <div className="sample-block" id="treegrid-fixed-columns">
                    <IntegralUITreeGridComponent ref={this.gridRef}
                        allowAnimation={this.state.isAnimationAllowed} 
                        columns={this.state.columns} 
                        customStyle={iuiTreeGridFixedColumnsStyle}
                    ...
                    <div className="feature-help">
                        <p><span className="initial-space"></span>In this sample, first two columns are fixed on left side of the TreeGrid, while other columns remain non-fixed. When scrolling the grid view, the fixed columns will remain at the same position.</p>
                        <p><span className="initial-space"></span>You can fix columns either on left or right side of the TreeGrid. The view will display columns following this priority (from top to low): left, right, none. This means that columns fixed on left side will appear in front of all other columns.</p>
...
export default TreeGridFixedColumns;
