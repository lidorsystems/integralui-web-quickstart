        ...
        return (
            <div>
                ...
                <div className="sample-block">
                    <IntegralUIListBoxComponent id="listbox-dragdrop-overview" ref={this.listRef}
                        allowDrag={this.state.allowDrag}
                        allowDrop={this.state.allowDrop}
                        customStyle={iuiListBoxDragDropOverviewStyle}
                    ...
                    <div className="sample-block-ddlb-control-panel">
                        ...
                        <label><input type="checkbox" defaultChecked={this.state.isGrouped} onChange={(e) => this.setState({ isGrouped: e.target.checked})} /> Show Groups</label>
                        <br/>
                ...
                <div className="feature-help" style={{ marginTop: '20px' }}>
                    <p><span className="initial-space"></span>In this sample you can drag drop items within the same ListBox. There are two different ways to drag and drop items:</p>
...
export default ListBoxDDOverview;
