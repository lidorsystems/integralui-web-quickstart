...
import { iuiListBoxDDEventStyle } from './listbox-dragdrop-events.style.js';

import './listbox-dragdrop-events.css';

class ListBoxDDEVents extends Component {
    constructor(props){
        super(props);
    ...
    render() {
        return (
            <div>
                ...
                <div className="sample-block-listbox-dragdrop-events">
                    <IntegralUIListBoxComponent id="listbox-dragdrop-events" ref={this.listRef}
                        allowDrag={true}
                        allowDrop={true}
                    ...
                    <div className="sample-event-block">
                        ...
                        <p>Event log:</p>
                        <IntegralUIListBoxComponent id="listbox-dragdrop-events-log" ref={this.evListRef}
                            allowFocus={false}
                            customStyle={iuiListBoxDDEventStyle}
                    ...
                    <div className="feature-help">
                        <p><span className="initial-space"></span>In this demo, you are free to drag and drop items one by one within the ListBox. When item is dragged over a different item, you can drop it above or below the target item. In this particular example, you cannot drop items above or below the <strong><i>"Gladiator"</i></strong> item, the above and below positions are disabled within the <strong>dragOver</strong> event handler.</p>
                        ...
                        <ul className="feature-points">
                            <li><span className="code-name">dragEnd</span> - occurs when HTML5 drag and drop operation ends over ListBox space</li>
                            <li><span className="code-name">dragEnter</span> - occurs when item is dragged over ListBox space for the first time</li>
                            <li><span className="code-name">dragDrop</span> - occurs when item drops within the ListBox</li>
                            <li><span className="code-name">dragLeave</span> - occurs when dragged item leaves the ListBox space</li>
                            <li><span className="code-name">dragOver</span> - occurs when item is dragged over other items and ListBox space</li>
                            <li><span className="code-name">dragStart</span> - occurs  when HTML5 drag and drop operation starts over ListBox space</li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default ListBoxDDEVents;
