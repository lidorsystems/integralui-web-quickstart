...
import './listbox-dragdrop-listview.css';

class ListBoxDDListView extends Component {
        ...
        return (
            <div>
                ...
                <div className="feature-help" style={{ marginTop: '20px' }}>
                    <p><span className="initial-space"></span>In this sample you can drag drop items between ListBox and ListView components. The Dynamic drag and drop is active, which means when one or more items are dragged all other items will move and show the target position at which dragged items can drop.</p>
...
export default ListBoxDDListView;
