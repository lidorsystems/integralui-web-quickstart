...
import gridData from './grid-overview-data.json';
            ...
            <div>
                ...
                <div className="sample-block" id="grid-overview">
                    ...
                    <div className="feature-help">
                        <p><span className="initial-space"></span><strong><span className="code-name">IntegralUI</span> Grid</strong> is a native Web Component that displays hierarchical data structures in multiple columns. You can load data on demand during run-time from local or remote data sources, and add custom HTML content or other components in each grid cell.</p>
                        <p><span className="initial-space"></span>In above demo, the grid has columns with different content: <Link to="/checkbox">checkbox</Link>, <Link to="/rating">rating</Link> and label. In this example, check boxes can have 2 values: checked or unchecked, but you can change this easily by providing three values.</p>
                        <p><span className="initial-space"></span>Some columns have their content aligned to center, while others have their alignment set to left.</p>
