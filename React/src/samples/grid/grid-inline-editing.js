...
import gridData from './grid-inline-editing-data.json';
import { iuiGridInlineEditingStyle } from './grid-inline-editing.style.js';

// Import editor components
import 'integralui-web/components/integralui.datepicker.js';
import 'integralui-web/components/integralui.select.js';

class GridInlineEditing extends Component {
    ...
    render() {
        return (
            <div>
                ...
                <div className="sample-block" id="grid-inline-editing">
                    <IntegralUIGridComponent ref={this.gridRef}
                        allowAnimation={this.state.isAnimationAllowed} 
                        columns={this.state.columns} 
                        customStyle={iuiGridInlineEditingStyle}
...
export default GridInlineEditing;
