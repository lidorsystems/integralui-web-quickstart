...
class GridExport extends Component {
    ...
    render() {
        return (
            <div>
                <h2>Grid / Export</h2>
                <div className="sample-block-grd-expt" id="grid-export">
                    ...
                    <div className="sbp-grd-expt" align="center">
                    ...
                    <div className="feature-help">
                        <p><span className="initial-space"></span>This example presents how to export the Grid data to Excel CSV file or a JSON formatted string. When exporting to JSON, the final result is shown in console window.</p>
