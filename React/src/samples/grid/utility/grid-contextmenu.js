...
import { iuiGridContextMenuStyle } from './grid-contextmenu.style.js';

class GridContextMenu extends Component {
    ...
    rowMenuClick(e){
        if (e.detail.item){
            ...
            switch (e.detail.item.id){
                case 3:
                    this.gridRef.current.addRow(this.createNewRow());
                    break;
    ...
    render() {
        return (
            <div>
                <h2>Grid / Context Menu</h2>
                <div className="sample-block" id="grid-contextmenu">
                    ...
                    <div className="feature-help">
                        <p><span className="initial-space"></span>In this sample you can see how to add a <strong>ContextMenu</strong> to columns and rows in Grid component. To open the context menu, right-click anywhere inside a coumn header or a row.</p>
